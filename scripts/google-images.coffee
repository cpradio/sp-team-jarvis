...
#
# Commands:
#   hubot image me <query> - The Original. Queries Google Images for <query> and returns a random top result. #images
#   hubot animate me <query> - The same thing as `image me`, except adds a few parameters to try to return an animated GIF instead. #images
#   hubot mustache me <url> - Adds a mustache to the specified URL. #images
#   hubot mustache me <query> - Searches Google Images for the specified query and mustaches it. #images
