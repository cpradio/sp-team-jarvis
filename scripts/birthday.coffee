...
#
# Commands:
#   hubot birthday quote for <user> -- congratulate <user> with a random birthday quote #celebrate #bday
#   hubot celebrate me <user> -- congratulate <user> with an inspirational greeting #celebrate #bday
#   hubot happy birthday me <user> -- congratulate <user> with a humorous greeting #celebrate #bday
#
# Author:
#   sopel
